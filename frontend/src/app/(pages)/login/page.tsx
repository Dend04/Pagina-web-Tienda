          ...
          <div className="hidden lg:flex lg:w-1/2 bg-linear-to-br from-pucara-primary/5 to-pucara-blue/5 p-12 flex-col justify-center">
            <div className="flex items-center gap-4 mb-4">
              ...
              <h1 className="text-4xl md:text-4xl font-extrabold">
                <span className="bg-linear-to-r from-pucara-primary to-pucara-blue bg-clip-text text-transparent">
                  IPSA Pucara SA
                </span>
              </h1>
            </div>
            ...
            <div className="w-full max-w-md h-1 bg-linear-to-r from-pucara-primary to-pucara-blue rounded-full"></div>
          </div>
